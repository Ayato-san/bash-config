# Generated by Powerlevel10k configuration wizard on 2025-02-20 at 11:24    .
...
# lightest, angled separators, sharp heads, sharp tails, 1 line, compact, many icons,
...
() {
  ...
  #
  typeset -g POWERLEVEL9K_DIR_CLASSES=(
    '~/local/dev/Typescript(|/*)'       TS       ''
    '~/local/dev/Javascript(|/*)'       JS       ''
    '~/local/dev/golang(|/*)'           GO       ''
    '~/local/dev/python(|/*)'           PY       ''
    '~/local/dev(|/*)'                  DEV      ''
    '~/local/docker(|/*)'               DOCKER   ''
  ...
  # Styling for TS.
  typeset -g POWERLEVEL9K_DIR_TS_VISUAL_IDENTIFIER_EXPANSION=''
  typeset -g POWERLEVEL9K_DIR_TS_FOREGROUND=31
  typeset -g POWERLEVEL9K_DIR_TS_SHORTENED_FOREGROUND=103
  typeset -g POWERLEVEL9K_DIR_TS_ANCHOR_FOREGROUND=39
  # Styling for JS.
  ...
  # Styling for GO.
  typeset -g POWERLEVEL9K_DIR_GO_VISUAL_IDENTIFIER_EXPANSION=''
  typeset -g POWERLEVEL9K_DIR_GO_FOREGROUND=31
  typeset -g POWERLEVEL9K_DIR_GO_SHORTENED_FOREGROUND=103
  typeset -g POWERLEVEL9K_DIR_GO_ANCHOR_FOREGROUND=39
  # Styling for PY.
  typeset -g POWERLEVEL9K_DIR_PY_VISUAL_IDENTIFIER_EXPANSION=''
  typeset -g POWERLEVEL9K_DIR_PY_FOREGROUND=31
  typeset -g POWERLEVEL9K_DIR_PY_SHORTENED_FOREGROUND=103
  typeset -g POWERLEVEL9K_DIR_PY_ANCHOR_FOREGROUND=39
  # Styling for DEV.
  typeset -g POWERLEVEL9K_DIR_DEV_VISUAL_IDENTIFIER_EXPANSION=''
  typeset -g POWERLEVEL9K_DIR_DEV_FOREGROUND=31
  typeset -g POWERLEVEL9K_DIR_DEV_SHORTENED_FOREGROUND=103
  typeset -g POWERLEVEL9K_DIR_DEV_ANCHOR_FOREGROUND=39
  # Styling for DOCKER.
  typeset -g POWERLEVEL9K_DIR_DOCKER_VISUAL_IDENTIFIER_EXPANSION=''
  typeset -g POWERLEVEL9K_DIR_DOCKER_FOREGROUND=31
  typeset -g POWERLEVEL9K_DIR_DOCKER_SHORTENED_FOREGROUND=103
  typeset -g POWERLEVEL9K_DIR_DOCKER_ANCHOR_FOREGROUND=39
  # Styling for HOME.
